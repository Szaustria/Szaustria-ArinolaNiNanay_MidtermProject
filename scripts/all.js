...
define("scripts/sence.js", function(exports){
	...
	exports.showMenu = function( callback ){
	    ...
	    saba = fruit.create( "saba", 330, 322, true );
	    boom = fruit.create( "boom", 552, 367, true, 2500 );
	
	    [ saba, boom ].forEach(function( f ){ f.isHomeMenu = 1; });
	    saba.isNewGameIcon = boom.isQuitIcon = 1;
...
define("scripts/factory/fruit.js", function(exports){
	...
	var infos = {
		...
		boom: [ "images/fruit/boom.png", 80, 68, 26, 0, 0, null ],
		tundan: [ "images/fruit/tundan.png", 98, 85, 38, -100, 0, "#FFFF00"],
		saba: [ "images/fruit/saba.png", 130, 80, 40, 34, 0, "#FFFF00" ],
		kamote: [ "images/fruit/kamote.png", 130, 80, 40, 34, 0, "#800080" ],
		balanghoy: [ "images/fruit/balanghoy.png", 140, 80, 30, 34, 0, "#8B4513"]
	};
	

	var types = ["tundan", "saba", "kamote", "balanghoy" ];
...
define("scripts/object/score.js", function(exports){
	...
	exports.set = function(){
	    ...
	    text2 = layer.createText( "default", "BEST 471", text2Sx, 48, "#af7c05", "14px" ).hide();
	};
